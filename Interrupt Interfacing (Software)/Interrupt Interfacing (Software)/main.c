/*
 * Interrupt Interfacing (Software).c
 *
 * Created: 22-09-2022 10:42:30 AM
 * Author : kartik.iot
 */ 
...
{
	PORTB = 0b00000001;
	volt_d = (int)(4.887*ADC) / 1000;
	volt_f = (int)(4.887*ADC) % 1000;
...
int main(void)
{
	...
	LCD_initiate();
	ADC_Init(0);
	sei(); // start the interrupt monitoring
	while (1)
	{
		ADCSRA = ADCSRA | 0b01000000;// STart bit is set to 1
		_delay_ms(100);_delay_ms(100);
		LCD_config(0xC0);LCD_Print("In main function");
		_delay_ms(300);
	}
}